<template>
  <AdminLayout page-title="Attendance" add-label="Mark Attendance" @add="showMarkModal = true">
    ...
    <div class="att-grid">
      ...
      <div class="right-col">
        ...
        <div class="card">
          ...
          <div class="mini-list" v-if="absentList.length">
            <div class="mini-row" v-for="a in absentList" :key="a.empCode">
          ...
          <div v-else class="mini-empty">Full attendance today ✓</div>
        </div>
    ...
    <div class="card monthly-card">
      <div class="card-hd">
        <div>
          <div class="card-title">Monthly Attendance Overview — {{ currentMonthLabel }}</div>
          <div class="card-sub">Daily presence across the organisation</div>
        </div>
        <button class="card-link" @click="exportCSV">Download Report →</button>
      </div>
      <div class="monthly-chart">
        <div class="mc-col" v-for="(d, i) in monthlyData" :key="i">
          <div class="mc-bar-wrap">
            <div
              class="mc-bar"
              :style="{ height: d.pct + '%', background: barColor(d.pct) }"
      ...
      <div class="modal">
        ...
        <div class="modal-body">
          <div class="mfield">
            ...
            <select v-model="mark.employeeCode">
              <option disabled value="">Select Employee</option>
              <option v-for="e in employees" :key="e.id" :value="e.employeeCode">
          ...
          <div class="mform-row">
            <div class="mfield">
              <label>Date</label>
              <input type="date" v-model="mark.date">
            </div>
            <div class="mfield">
              <label>Punch Type</label>
              <select v-model="mark.punchType">
          ...
          <div class="mform-row">
            <div class="mfield">
              <label>Time</label>
              <input type="time" v-model="mark.time">
            </div>
            <div class="mfield">
              <label>Source</label>
              <select v-model="mark.source">
          ...
          <div class="mfield">
            ...
            <input type="text" v-model="mark.remarks" placeholder="e.g. Working from home">
          </div>
        </div>
        <div class="modal-ft">
          <button class="btn-cancel" @click="showMarkModal = false" :disabled="saving">Cancel</button>
          <button class="btn-save" @click="saveAttendance" :disabled="saving || !mark.employeeCode">
